...
var Async = /*#__PURE__*/(process.env.NODE_ENV === 'production' ? I.id : I.freeze)({
  map: chain,
...
var casesOf = /*#__PURE__*/(process.env.NODE_ENV === 'production' ? I.id : validate(modifyAfter(freeFn(choose(function (args) {
...
var promote = /*#__PURE__*/(process.env.NODE_ENV === 'production' ? I.id : validate(freeFn([function (xs) {
...
var upgrades = /*#__PURE__*/(process.env.NODE_ENV === 'production' ? I.id : validate(freeFn([function (xs) {
  return length(xs) === 0 || xs.every(function (c) {
...
var upgradesOf = /*#__PURE__*/(process.env.NODE_ENV === 'production' ? I.id : validate(freeFn([function (xs) {
